...
Module['ready'] = new Promise(function(resolve, reject) {
  ...
  readyPromiseReject = reject;
      ...
      if (!Object.getOwnPropertyDescriptor(Module['ready'], '_detectCode')) {
        Object.defineProperty(Module['ready'], '_detectCode', { configurable: true, get: function() { abort('You are getting _detectCode on the Promise object, instead of the instance. Use .then() to get called back with the instance, see the MODULARIZE docs in src/settings.js') } });
        Object.defineProperty(Module['ready'], '_detectCode', { configurable: true, set: function() { abort('You are setting _detectCode on the Promise object, instead of the instance. Use .then() to get called back with the instance, see the MODULARIZE docs in src/settings.js') } });
      }
    

      if (!Object.getOwnPropertyDescriptor(Module['ready'], '_allocateBuffer')) {
        Object.defineProperty(Module['ready'], '_allocateBuffer', { configurable: true, get: function() { abort('You are getting _allocateBuffer on the Promise object, instead of the instance. Use .then() to get called back with the instance, see the MODULARIZE docs in src/settings.js') } });
        Object.defineProperty(Module['ready'], '_allocateBuffer', { configurable: true, set: function() { abort('You are setting _allocateBuffer on the Promise object, instead of the instance. Use .then() to get called back with the instance, see the MODULARIZE docs in src/settings.js') } });
      }
...
/** @type {function(...*):?} */
var _allocateBuffer = Module["_allocateBuffer"] = createExportWrapper("allocateBuffer");

/** @type {function(...*):?} */
var _detectCode = Module["_detectCode"] = createExportWrapper("detectCode");
...
var ___emscripten_embedded_file_data = Module['___emscripten_embedded_file_data'] = 1279152;
